...
local train_data_path = "data/pretrain_2tsl_moretsl_canonical/train_pretrain_s4_canonical.jsonl";
local dev_data_path = "data/pretrain_2tsl_moretsl_canonical/dev_pretrain_s4_canonical.jsonl";
local easy_dev_data_path = "data/pretrain_2tsl_moretsl_canonical/easy_dev_pretrain_s4_canonical.jsonl";
local test_data_path = "data/pretrain_2tsl_moretsl_canonical/test_pretrain_s4_canonical.jsonl";
...

{
  ...
  "steps": [
   ...
   {
    "name": "pretrain_2tsl_moretsl_canon",
    "f": "pretrain",
    "model": {
    ...
    "save_dir": "models/w_fsts_pretrain_s4_32_tsl_moretsl_canon",
